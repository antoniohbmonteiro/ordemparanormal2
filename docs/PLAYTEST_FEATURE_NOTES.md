...
POIs usam somente `system.information[].approaches[]`; o antigo `system.skills[]` não é suportado. Não há migração automática entre os formatos nesta fase 0.x. POIs antigos podem precisar ser recriados manualmente ou restaurados/reimportados futuramente.
