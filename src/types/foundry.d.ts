...
declare const game: {
  ...
  readonly items: foundry.documents.collections.Items;
  readonly scenes: foundry.documents.collections.Scenes;
...
declare const ui: {
  readonly notifications: {
    error(message: string, options?: { readonly permanent?: boolean }): void;
