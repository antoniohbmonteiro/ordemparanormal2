...
module.exports = tseslint.config(
  ...
  tseslint.configs.recommended,
  {
    ...
    rules: {
      ...
      '@typescript-eslint/no-unused-vars': [
        ...
        {
          argsIgnorePattern: '^_',
          // Each concatenated source file contributes to this shared namespace.
          varsIgnorePattern: '^(?:_|OP2Foundations$)',
  ...
  },
  {
    files: ['src/**/*.ts'],
    rules: {
      // Namespaces let tsc concatenate this classic plugin without a runtime bundler.
